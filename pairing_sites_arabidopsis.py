...
chromatin = pbt.BedTool(input_path + 'arabidopsis_chromatin.bed')
...
CGdf = pd.read_table(CGstates.fn, names = ['chrom','start','end','strand','methylation','chrom2','state_start','state_end','type'], index_col = False)
mCGdf = pd.read_table(mCstates.fn, names = ['chrom','start','end','strand','methylation','chrom2','state_start','state_end','type'], index_col = False)
