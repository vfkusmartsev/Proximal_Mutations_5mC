...
CG = pd.read_table(input_path+'me_cytosines/%s_H1_%s_lifted.txt' %(context, chromosome), names = ['chrom','start','end','strand','methylation'])
mCG = pd.read_table(input_path+'me_cytosines/m%s_H1_%s_lifted.txt' %(context, chromosome), names = ['chrom','start','end','strand','methylation'])
...
CGdf = pd.read_table(CGstates.fn, names = ['chrom','start','end','strand','methylation','chrom2','state_start','state_end','type','score','thickStart','thickEnd','rgb'], index_col = False)
mCGdf = pd.read_table(mCstates.fn, names = ['chrom','start','end','strand','methylation','chrom2','state_start','state_end','type','score','thickStart','thickEnd','rgb'], index_col = False)
...
for k in [5]:
	...
	# save output file
	paired_all.to_csv(output_path + 'human_chromatin_paired_10_%s_%s_k%s_%s.txt' %(mask_str, context, k, chromosome), sep = '\t', header = True)
